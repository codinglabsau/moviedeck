...
<nav class="bg-white shadow">
    <div class="container px-10 py-6 mx-auto md:flex">
        <div class="flex items-center justify-between align-bottom">
            ...
            <a class="text-md font-bold uppercase text-gray-700 md:text-base hover:text-gray-600" href="{{ route('front') }}">Moviedeck</a>
                    ...
                    <button class="flex items-center ml-5 px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                        <svg class="w-5 h-5 mx-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            @if (Route::has('register'))
                                <span class="mx-2 whitespace-nowrap"><a class="no-underline hover:underline" href="{{ route('register') }}">{{ __('Register') }}</a></span>
                            @endif
                    </button>
                @else
