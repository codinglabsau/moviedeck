        ...
        <div class="container px-10 py-6 mx-auto md:flex">
            ...
            <div class="w-full ml-28 md:flex md:items-center md:justify-between">
                <div class="flex flex-col px-2 py-3 -mx-4 md:flex-row md:mx-0 md:py-0">
                    <a href="{{ route('movies.index') }}" class="px-2 py-1 text-sm font-medium text-gray-600 transition-colors duration-200 transform rounded hover:bg-blue-700 hover:text-gray-100 md:mx-2">Movies</a>
                    <a href="{{ route('celebs.index') }}" class="px-2 py-1 text-sm font-medium text-gray-600 transition-colors duration-200 transform rounded hover:bg-blue-700 hover:text-gray-100 md:mx-2">Celebs</a>
                    <a href="{{ route('reviews.index') }}" class="px-2 py-1 text-sm font-medium text-gray-600 transition-colors duration-200 transform rounded hover:bg-blue-700 hover:text-gray-100 md:mx-2">Reviews</a>
                </div>
                ...
                <div class="w-full lg:w-2/3">
                    <div class="px-6">
                        <div class="flex align-bottom items-center">
                            ...
                            <a class="text-md font-bold uppercase text-gray-300 md:text-base hover:text-gray-200" href="#">Moviedeck</a>
                        </div>
