                    ...
                    <form method="GET" action="{{ route('search') }}" class="flex items-center border-2 rounded-md">
                        <div class="flex flex-row">
                            ...
                            <div class="inset-y-0 right-0 flex items-center">
                                <select id="switch" name="switch" class="focus:outline-none h-full py-0 pl-2 pr-8 border-gray-300 border-l-0 bg-transparent text-gray-500 sm:text-sm rounded-md rounded-l-none">
