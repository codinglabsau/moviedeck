...
@section('content')
    <div class="w-full bg-fixed bg-bottom bg-cover shadow-inner" style="background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(27, 28, 32, 1)), url('{{ $movies->first()->banner }}')">
            ...
            <section class="text-gray-600 body-font">
                ...
                <div class="container mx-auto flex px-5 py-32 md:flex-row flex-col items-center align-baseline">
                    <div class="w-full lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <h1 class="title-font sm:text-6xl text-5xl mb-4 font-medium text-white"> {{ $movies->first()->title }}  </h1>
                        <div class="flex justify-center mb-12">
