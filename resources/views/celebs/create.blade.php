        ...
        <form method="POST" action="{{ route('celebs.store') }}">
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div>
                    ...
                    <input id="name" name="name" type="text" value="{{ old('name') }}" class="@error('name') is-invalid @enderror block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring">
                    @error('name')
                ...
                <div>
                    ...
                    <input id="date_of_birth" name="date_of_birth" type="date" value="{{ old('date_of_birth') }}" class="@error('date_of_birth') is-invalid @enderror block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    @error('date_of_birth')
                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="flex flex-col mt-10">
                <div class="flex flex-row align-middle items-center">
                    ...
                    <a class="text-gray-400 hover:text-gray-600 px-4 py-2" href="{{ route('celebs.index') }}">Cancel</a>
                </div>
            </div>
        </form>
    </section>
