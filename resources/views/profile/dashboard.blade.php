    ...
    <div class="flex w-3/4 my-24 mx-auto bg-white shadow-md">
        ...
        <div class="flex flex-col w-1/5 pb-8 bg-gray-600 border-r">
            ...
            <div class="flex flex-col justify-between flex-1 mt-6">
                <nav>
                    <a class="flex items-center pl-4 p-2 text-gray-100 transition-colors duration-200 transform bg-gray-700 hover:text-gray-200" href="{{ route('profile.dashboard', $user->id) }}">
                    ...
                    @foreach($reviews as $review)
                        <div class="flex">
                            ...
                            <div class="mt-1 flex flex-col items-start ml-6">
                                ...
                                <a href="{{ route('reviews.show', ['movie'=>$review->movie->id, 'review'=>$review->id]) }}" class="hover:text-gray-500 text-lg font-medium text-left leading-none text-gray-600 my-2">
                                    {{$review->title}}
                                </a>
