        ...
        <div class="flex flex-col w-32 md:w-64 h-screen pb-8 bg-white border-r">
            ...
            <div class="flex flex-col justify-between flex-1 mt-6">
                <nav>
                    ...
                    @if (Auth::user()==$user)
                        <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="{{ route('watchlist.index', $user->id) }}">
                            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            @if (Auth::user()==$user)
                <div class="container w-full px-14 py-10 mx-auto">
                    <div class="flex justify-between">
                        ...
                        <div class="flex items-center px-4 py-2 font-medium tracking-wide capitalize transition-colors duration-200 transform rounded-md border-2 border-gray-300">
                            <a href="{{ route('watchlist.index', $user->id) }}"><span class="mx-2 whitespace-nowrap">{{$watchlist_count}} | Manage List</span></a>
                        </div>
                    </div>
