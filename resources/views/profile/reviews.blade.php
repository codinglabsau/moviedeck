    ...
    <div class="flex w-5/6 my-10 mx-auto bg-white shadow-md">
        ...
        <div class="flex flex-col w-32 md:w-64 h-screen pb-8 bg-gray-600 border-r">
            ...
            <div class="flex flex-col justify-between flex-1 mt-6">
                <nav>
                    <a class="flex items-center px-4 py-2 text-gray-100 transition-colors duration-200 transform hover:bg-gray-700 hover:text-gray-200" href="{{ route('profile.dashboard', $user->id) }}">
                    ...
                    <div class="flex items-center px-4 py-2 mt-5 text-gray-100 bg-gray-700">
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
