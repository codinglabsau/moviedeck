    ...
    <div class="container px-6 py-3 mx-auto md:flex">
        <section class="text-gray-600 body-font">
            <div class="flex justify-between mb-12 pt-24">
                <div class="flex items-center ml-5 px-4 py-2 font-medium text-white tracking-wide capitalize">
                    <h1 class="font-medium text-gray-500 text-4xl px-4 whitespace-nowrap">Popular Movies</h1>
                </div>
